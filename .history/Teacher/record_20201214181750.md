...
```
          ...
          str += "<tr><td>" + j + "</td><td id=\"" + Topic_titleID + "\">" + data.Topic_title[i] + "</td><td id=\"" + Topic_detailsID + "\">" + data.Topic_details[i] + "</td><td id=\"" + TutorID + "\">" + data.Tutor[i] + "</td><td><input type=\"checkbox\" id = \"" + yesID + "\">是<input type =\"checkbox\" name=\"deny\" id=\"" + denyID + "\">否</td></tr>"
